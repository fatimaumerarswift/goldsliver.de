...
const cards = [
  {
    ...
    title: "Luxury Resale Market Shows\nContinued Growth Momentum",
    desc: "Demand for certified pre-owned jewelry remains strong across global markets.",
    image: "/jewelry.png"
  },
  {
    name: "PHYSICAL MARKET",
...
export default function JewelryUpdates() {
  return (
    <>
