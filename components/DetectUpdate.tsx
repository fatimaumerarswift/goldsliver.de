...
const cards = [
  {
    ...
    title: "Custom Jewelry Demand Supports\nModern Goldsmith Craftsmanship",
    desc: "Consumers increasingly value handcrafted pieces and premium metal artistry.",
    image: "/detection.png"
  },
  {
    name: "PHYSICAL MARKET",
...
export default function DetectUpdates() {
  return (
    <>
